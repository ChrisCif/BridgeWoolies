 ...
 *
 * Version:
 * $Id: RunWoolies.java,v 1.1 2015/11/14 15:49:46 cmc5193 Exp $
 */
...
public class RunWoolies {
    ...
    static void test2() {
        ...
        // Create the Woolies and store them in an array.
        Thread peds[] = {
        	new Woolie("Sans", 2, SIDE_ONE, trollBridge),
        	new Woolie("Papyrus", 2, SIDE_TWO, trollBridge),
        	new Woolie("Undyne", 3, SIDE_ONE, trollBridge),
        	new Woolie("Alphys", 3, SIDE_ONE, trollBridge),
        	new Woolie("Asgore", 5, SIDE_TWO, trollBridge),
        	new Woolie("Toriel", 2, SIDE_TWO, trollBridge),
        };
    ...
    static void test3() {
        ...
        Thread peds[] = {
        		new Woolie("Crono", 1, SIDE_ONE, trollBridge),
        		new Woolie("Luca", 4, SIDE_TWO, trollBridge),
        		new Woolie("Marle", 4, SIDE_ONE, trollBridge),
        		new Woolie("Frog", 3, SIDE_ONE, trollBridge),
        		new Woolie("Robo", 6, SIDE_TWO, trollBridge),
        		new Woolie ("Ayla", 2, SIDE_TWO, trollBridge),
        };
 ...
 * Revision 1.1  2015/11/14 15:49:46  cmc5193
 * the first one
 *
